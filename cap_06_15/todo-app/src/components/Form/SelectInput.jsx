...
function SelectInput({ name, value, onChange, onBlur, options, placeholder, label, error }) {
  ...
  return (
    <div className="mb-4">
      ...
      <select id={name} name={name} className={selectCls} value={value} onChange={onChange} onBlur={onBlur}>
