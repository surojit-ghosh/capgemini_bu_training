  ...
  return (
    <div className="max-w-[1160px] mx-auto px-6 py-8 font-sans">
      <div className="flex items-center justify-between gap-4 mb-6">
        <h1 className="text-xl font-bold text-zinc-950 font-display uppercase tracking-wider">Admin Dashboard</h1>
        {highPriorityOpenCount > 0 && (
          <div className="inline-flex items-center gap-2 bg-zinc-100 border border-zinc-300 text-zinc-800 text-[10px] font-semibold uppercase tracking-wider px-2.5 py-1 rounded">
      ...
      {safeRequests.length > 0 && (
        <div className="border border-zinc-200 rounded p-5 bg-white mb-6">
