              ...
              <td className="py-3 px-4">
                <div className="flex items-center gap-2">
                  ...
                  {req.status === STATUSES.OPEN && (
                    <button
                      className="bg-neutral-100 hover:bg-neutral-200 text-neutral-900 border border-neutral-300 rounded px-2.5 py-1 text-[11px] font-medium transition cursor-pointer"
                  ...
                  {req.status === STATUSES.RESOLVED && (
                    <button
                      className="bg-white hover:bg-neutral-50 text-neutral-500 border border-neutral-200 rounded px-2.5 py-1 text-[11px] font-medium transition cursor-pointer"
